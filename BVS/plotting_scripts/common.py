...
LATEX_PAPER_WIDTH_M = 0.375  # "Portrait Letter / ANSI A", not DIN A4
LATEX_PAPER_WIDTH_IN = LATEX_PAPER_WIDTH_M * 39.37
LATEX_PAPER_PAPERWIDTH_PT = 597.50787
...
"""
LATEX_PAPER_TEXTWIDTH_PT = 345.0
LATEX_PAPER_COLUMN_WIDTH_PT = 345.0
...
def set_plotting_style(style: str, enable_pgf=True):
    ...
    if style == 'presentation':
        ...
        style_default_width_pt = PRESENTATION_WIDTH_PT
