...
namespace ns3 {
    ...
    private:
        ...
        static double m_deltaT; // the message step interval (duration between each step).
    ...
    public:
        Bloodcircuit()=default;
        /// The constructor setting up the Bloodcircuit.
        Bloodcircuit(unsigned int numberOfNanobots, unsigned int injectionVessel);
